...
VALUES ('hybrid-race-plan', 'Hybrid Race Plan', '/my-programmes/hybrid-race-plan', 'compete'::product_collection, 'published'::product_status)
ON CONFLICT (slug) DO UPDATE
SET name = EXCLUDED.name,
    base_path = EXCLUDED.base_path,
    status = 'published'::product_status;

UPDATE public.products SET price_cents = 1999 WHERE slug = 'hybrid-race-plan';
