    ...
    <section className="min-h-[60vh] grid place-items-center px-5 py-20 bg-background">
      <div className="max-w-md text-center">
        ...
        <div className="mt-8 flex justify-center gap-4">
          ...
          <Link to="/programmes/hybrid-race-plan" className="h-11 px-6 inline-flex items-center bg-bone text-obsidian text-xs uppercase tracking-widest font-display">View product</Link>
        </div>
      </div>
    </section>
  );
