...
const BASE = "/my-programmes/sem-2027";
const primary = [
...
export function Sem27Shell({ children, eyebrow, title }: { children: ReactNode; eyebrow?: string; title?: string }) {
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground flex">
      <aside className="hidden lg:flex flex-col w-[240px] shrink-0 border-r border-border bg-background sticky top-0 h-dvh px-6 py-8">
        <div className="mb-12">
          <Wordmark size="lg" />
          <p className="eyebrow mt-3">S.E.M. 2027</p>
        </div>
  ...
  return (
    <section className="min-h-[60vh] grid place-items-center px-5 py-20 bg-background">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display font-bold text-bone text-3xl tracking-tight uppercase">Sign in to access S.E.M. 2027</h1>
  ...
  return (
    <section className="min-h-[60vh] grid place-items-center px-5 py-20 bg-background">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display font-bold text-bone text-3xl tracking-tight uppercase">S.E.M. 2027 isn't in your library</h1>
