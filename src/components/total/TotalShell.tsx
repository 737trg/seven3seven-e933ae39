...
export function TotalShell({ children, eyebrow, title }: { children: ReactNode; eyebrow?: string; title?: string }) {
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground flex">
      <aside className="hidden lg:flex flex-col w-[240px] shrink-0 border-r border-border bg-background sticky top-0 h-dvh px-6 py-8">
        <div className="mb-12">
          <Wordmark size="lg" />
          <p className="eyebrow mt-3">BUILD TOTAL</p>
        </div>
  ...
  return (
    <section className="min-h-[60vh] grid place-items-center px-5 py-20 bg-background">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display font-bold text-bone text-3xl tracking-tight uppercase">Sign in to access BUILD TOTAL</h1>
  ...
  return (
    <section className="min-h-[60vh] grid place-items-center px-5 py-20 bg-background">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display font-bold text-bone text-3xl tracking-tight uppercase">BUILD TOTAL isn't in your library</h1>
        <p className="text-foreground-muted text-sm mt-4">Buy BUILD TOTAL outright or join the Club to unlock it.</p>
        <div className="mt-8 flex justify-center gap-4">
          ...
          <Link to="/programmes/$slug" params={{ slug: "build-total" }} className="h-11 px-6 inline-flex items-center bg-bone text-obsidian text-xs uppercase tracking-widest font-display">View product</Link>
        </div>
      </div>
    </section>
  );
