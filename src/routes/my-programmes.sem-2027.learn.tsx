...
export const Route = createFileRoute("/my-programmes/sem-2027/learn")({
  head: () => ({ meta: [{ title: "S.E.M. 2027 — Learn" }, { name: "robots", content: "noindex, nofollow" }] }),
  component: LearnPage,
});
...
function LearnPage() {
  const tabs = (SEM27 as any).learn?.tabs as Record<string, string[]> | undefined;
  ...
  return (
    <Sem27Shell eyebrow="Learn" title="Terms, standards, rules">
      ...
      <p className="mt-12 text-foreground-muted text-xs max-w-[60ch]">{SEM27.independent_disclaimer}</p>
    </Sem27Shell>
  );
}