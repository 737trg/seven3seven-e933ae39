...
export const Route = createFileRoute("/my-programmes/sem-2026/calculator")({
  head: () => ({ meta: [{ title: "S.E.M 2026 — Calculator" }, { name: "robots", content: "noindex, nofollow" }] }),
  component: CalcPage,
});
...
function CalcPage() {
  const cfg = (SEM as any).calculator as { lifts: string[]; percentages: number[]; rounding_kg: number; rpe_guide: Record<string, string> };
  ...
  return (
    <SemShell eyebrow="Loads & effort" title="Calculator">
