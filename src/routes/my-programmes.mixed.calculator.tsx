...
export const Route = createFileRoute("/my-programmes/mixed/calculator")({
  head: () => ({ meta: [{ title: "MIXED — Calculators" }, { name: "robots", content: "noindex, nofollow" }] }),
...
function CalculatorPage() {
  ...
  return (
    <MixedShell eyebrow="Tools" title="Calculators">
