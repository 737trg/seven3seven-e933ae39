...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Structured hybrid programmes. Built to be followed, not filed away." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "SEVEN3SEVEN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#090909" },
      { name: "twitter:title", content: "SEVEN3SEVEN — Hybrid Fitness | Performance" },
      { name: "twitter:description", content: "Structured hybrid programmes. Built to be followed, not filed away." },
