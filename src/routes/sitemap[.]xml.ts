...
const BASE_URL = "https://737trg.com";
...
const entries: SitemapEntry[] = [
  ...
  { path: "/programmes/basic-training-blueprint-plus", changefreq: "weekly", priority: "0.9" },
  ...
  { path: "/programmes/build-total", changefreq: "weekly", priority: "0.9" },
