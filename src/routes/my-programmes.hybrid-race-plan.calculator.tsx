...
function CalcPage() {
  const cfg = (HRP as any).calculator as { lifts: string[]; percentages: number[]; rounding_kg: number; rpe_guide: Record<string, string> };
  ...
  return (
    <HrpShell eyebrow="Loads & effort" title="Calculator">
